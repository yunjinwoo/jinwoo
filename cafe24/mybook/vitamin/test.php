...
{
	GLOBAL $arr_clean , $arr_call_data , $arr_call_data_index , $aStatus;
	...
	return print_box( $a, '상태:'.$arr_call_data_index.'(함수값:'.$cnt.')') ;
}

function box_checker_start($a)
{
	GLOBAL $aStatus, $arr_call_data, $use_call_index;
