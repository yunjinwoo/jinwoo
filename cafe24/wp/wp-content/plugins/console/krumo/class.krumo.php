...
<li class="krumo-child">
	<div class="krumo-element"
		...
		onMouseOut="krumo.out(this);">
			...
			(<em class="krumo-type krumo-null">NULL</em>)<span class="cursor">&nbsp;</span> 
	</div>
</li>
<?php
		}
		...
		<li class="krumo-child">
			<div class="krumo-element"
				...
				onMouseOut="krumo.out(this);">
					...
					(<em class="krumo-type">Recursion</em>)<span class="cursor">&nbsp;</span> 
			</div>
		...
		onMouseOut="krumo.out(this);">
			...
			(<em class="krumo-type">Array, <strong class="krumo-array-length"><?php echo 
				(count($data)==1)
					?("1 element")
					:(count($data)." elements");
				?></strong></em>)<span class="cursor">&nbsp;</span> 
...
<li class="krumo-child">
	...
	<div class="krumo-element<?php echo count($data) > 0 ? ' krumo-expand' : '';?>"
		...
		onMouseOut="krumo.out(this);">
			...
			<a class="krumo-name"><?php echo $name;?></a>
			(<em class="krumo-type">Object</em>)<span class="cursor">&nbsp;</span> 
...
<li class="krumo-child">
	...
	<div class="krumo-element"
		...
		onMouseOut="krumo.out(this);">
			...
			<a class="krumo-name"><?php echo $name;?></a>
			(<em class="krumo-type">Resource</em>)<span class="cursor">&nbsp;</span> 
...
<li class="krumo-child">
	...
	<div class="krumo-element"
		...
		onMouseOut="krumo.out(this);">
			...
			<a class="krumo-name"><?php echo $name;?></a>
			(<em class="krumo-type">Boolean</em>)<span class="cursor">&nbsp;</span> 
...
<li class="krumo-child">
	...
	<div class="krumo-element"
		...
		onMouseOut="krumo.out(this);">
			...
			<a class="krumo-name"><?php echo $name;?></a>
			(<em class="krumo-type">Float</em>)<span class="cursor">&nbsp;</span> 
