function drawColor(oName) {
    ...
    sHTML += "<font size=2>색상 :</font> <input type=text id='"+colText+"' contentEditable=true style=\"width:53;height:19px;font:10 arial,sans-serif\" onchange=\""+safe+".style.background=this.value;\">";
    sHTML += "</td></tr>";
    sHTML += "</table>";
    return sHTML;
}
