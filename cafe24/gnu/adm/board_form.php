...
<tr class='ht'>
    ...
    <td>조회수, 글쓴날 수정기능 막기</td>
    <td><input type=checkbox name=bo_hit_date_change value='1' <?=$board[bo_hit_date_change]?'checked':'';?>>사용 (조회수, 글쓴날 수정기능를 수정하는 기능을 막습니다. - 보드 관리자 이상만 적용)</td>
</tr>
<tr class='ht'>
    <td><input type=checkbox name=chk_use_sideview value=1></td>
    <td>글쓴이 수정기능 막기</td>
    <td><input type=checkbox name=bo_write_change value='1' <?=$board[bo_write_change]?'checked':'';?>>사용 (글쓴이를 수정하는 기능을 막습니다.)</td>
</tr>
<tr class='ht'>
    <td><input type=checkbox name=chk_use_sideview value=1></td>
    <td>글쓴이 사이드뷰</td>
