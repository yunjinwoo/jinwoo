...
<?php
if ($is_hit_date) { 
	$wr_hit = empty($wr_hit) ? 1 : $wr_hit ;	
	$wr_datetime = empty($wr_datetime) ? date("Y-m-d H:i:s") : $wr_datetime ;
?>
<tr>
    <td style='padding-left:20px; height:30px;'>· 조회수</td>
    <td><input class='field_pub_01' maxlength=20 size=15 name=wr_hit itemname="조회수" required value="<?=$wr_hit?>"></td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<tr>
    <td style='padding-left:20px; height:30px;'>· 날짜</td>
    <td><input class='field_pub_01' maxlength=20 size=15 name=wr_datetime itemname="날짜" required value="<?=$wr_datetime ?>"></td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<? } ?>
<?php
if ($is_name) { 
