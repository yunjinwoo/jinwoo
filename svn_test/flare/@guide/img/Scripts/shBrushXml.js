...
$(function(){
	var showDiv = function(){$(this).parent().next().show();} ;
	var hideDiv = function(){$(this).parent().next().hide();} ;
	$("p.code_nav").each(function(){
		$(this).find("a").eq(0).click(showDiv).end()
						 .eq(1).click(hideDiv);
	});

	$("p.code_nav_all > a ").eq(0).click(function(){
		$("p.code_nav").each(function(){
			$(this).find("a").eq(0).click(); 
		}); 
	}).click().end().eq(1).click(function(){
		$("p.code_nav").each(function(){
