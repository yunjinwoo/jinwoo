	...
	<li <?php comment_class('vcard'); ?> id="comment-<?php comment_ID(); ?>">
		...
		<header class="entry-header-comments">
				...
				<h3 class="entry-title-comments">
					<?php echo get_avatar( $comment, 28 ); ?><?php printf( __( '%s <span class="says">says on:</span>', 'wplook' ), sprintf( '<span class="fn">%s</span>', get_comment_author_link() ) ); ?> <span class="comment-date"><?php printf( __( '%1$s at %2$s', 'wplook' ), get_comment_date(), get_comment_time() ); ?></span>
				</h3>
